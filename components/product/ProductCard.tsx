      ...
      <Link href={`/products/${product.id}`}>
        ...
        <div className="relative rounded-xl overflow-hidden mb-2 sm:mb-3"
          style={{
            ...
            boxShadow: hovered ? '0 12px 32px rgba(0,0,0,0.12)' : '0 4px 12px rgba(0,0,0,0.03)',
          ...
          <button
            ...
            style={{
              ...
              boxShadow: '0 2px 12px var(--accent-light)',
        ...
        <div className="px-0.5 mt-3">
          <h3 className="text-[12px] sm:text-[13px] font-semibold leading-tight mb-1 line-clamp-2"
            style={{ color: hovered ? 'var(--accent)' : 'var(--shop-text)', transition: 'color 0.2s' }}>
            {product.name}
          </h3>

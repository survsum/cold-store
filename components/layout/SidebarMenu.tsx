...
const INFO_LINKS = [
  ...
  { label:'Returns',         href:'/shipping',  icon:Shield     },
  { label:'Help & Support',  href:'/contact',   icon:HelpCircle },
  { label:'Contact Us',      href:'/contact',   icon:Phone      },
  { label:'About Cold Dog',  href:'/about',     icon:Info       },
];
            ...
            <div className="flex items-center justify-between px-5 py-4"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[9px] tracking-[0.2em] uppercase font-bold" style={{ color:'var(--accent)' }}>Hot Deals</div>
                </div>
              </div>
            ...
            <div className="px-5 py-4" style={{ borderTop:'1px solid var(--border)' }}>
              {user ? (
                <button onClick={handleLogout}
                  ...
                  <span className="text-[13px] font-bold" style={{ color:'var(--accent)' }}>Sign Out</span>
                </button>
              ) : (

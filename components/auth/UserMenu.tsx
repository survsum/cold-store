    ...
    <div ref={ref} className="relative">
      ...
      >
        {user.avatar ? (
          ...
          <div className="w-7 h-7 rounded-full flex items-center justify-center text-[10px] font-bold text-white" style={{ background: 'linear-gradient(135deg, var(--accent), #1565c0)' }}>
            {initials}
          </div>
        )}

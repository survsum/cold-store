                    ...
                    <motion.div key="entry"
                      ...
                      <motion.button
                        ...
                        style={{
                          ...
                          background: loading ? 'rgba(255,255,255,0.1)' : 'linear-gradient(135deg,var(--accent),#b91c1c)',
                  ...
                  {step === 'otp' && (
                    <motion.div key="otp"
                      ...
                      <motion.button
                        ...
                        style={{
                          padding: '12px 20px', borderRadius: 12, fontSize: 13, fontWeight: 600, color: 'white',
                          background: (loading || otp.join('').length !== 6) ? 'rgba(255,255,255,0.08)' : 'linear-gradient(135deg,var(--accent),#b91c1c)',
